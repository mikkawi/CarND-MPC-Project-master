    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // polyfit only accepts Eigen::VectorXd .. h
          ...
          //******
          // Convert coordinates from map to car coordinates
          ...
          // ****
          // incorporate latency, by predicting the car state after 100 msecond
          // ***
          ...
          */
          ...
          state << px_latency, py_latency, psi_latency, v, cte_latency, epsi_latency;
          ...
          std::cout<< " delta_vals: " << delta_vals[0] << std::endl;
          std::cout<< " a_vals: " << a_vals[0] << std::endl;
          std::cout<< " delta_vals: " << delta_vals[1] << std::endl;
          std::cout<< " a_vals: " << a_vals[1] << std::endl;
          */
          double steer_value;
